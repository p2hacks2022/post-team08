        ...
        <main>
            ...
            <!-- <script>
                for (var i = 0; i < 1; i++) {
                    ...
                    datetime.textContent = "　{{$diary_time}}"

                    // message
                    const message = document.createElement("p");
                    message.setAttribute("class", "message_text");
                    message.textContent = "　{{$diary_txt}}";
            ...
            <div class="future_mails">
                <div class="future_mail">
                    <p class="datetime" >2022-12-25 </p>
                    <!-- <hr class="mail_border"> -->
                    <p class="message_text">{{$diary_txt}}</p>
                </div>
                <div class="inebody">
            ...
            <div class="future_mails">
                <div class="future_mail">
                    <p class="datetime" >2023-01-01 </p>
                    <!-- <hr class="mail_border"> -->
                    <p class="message_text">初日の出を富士山頂で見る！</p>
                </div>
                <div class="inebody">
                    <form id="form" class="diary_form" action="{{ url('/home')}}" method="post">
            ...
            <div class="future_mails">
                <div class="future_mail">
                    <p class="datetime" >2023-01-15</p>
                    <!-- <hr class="mail_border"> -->
                    <p class="message_text">共通テストで750点とる！！！
                    </p>
                </div>
                <div class="inebody">
                    <form id="form" class="diary_form" action="{{ url('/home')}}" method="post">
